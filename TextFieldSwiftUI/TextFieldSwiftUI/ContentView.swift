...
struct ContentView: View {
  ...
  var body: some View {
    VStack {
      HStack {
        DidEndEditingTextField(tag: 0, placeholder: "N", text: $text1, isFocus: $isTextFieldFocus1, triggersFocus: $triggersFocus1, onDeleteBackward: {
        ...
        DidEndEditingTextField(tag: 1, placeholder: "N", text: $text2, isFocus: $isTextFieldFocus2, triggersFocus: $triggersFocus2, onDeleteBackward: {
        ...
        .frame(width: 50, height: 50)
        DidEndEditingTextField(tag: 2, placeholder: "N", text: $text3, isFocus: $isTextFieldFocus3, triggersFocus: $triggersFocus3, onDeleteBackward: {
        ...
        .frame(width: 50, height: 50)
        DidEndEditingTextField(tag: 3, placeholder: "N", text: $text4, isFocus: $isTextFieldFocus4, triggersFocus: $triggersFocus4, onDeleteBackward: {
